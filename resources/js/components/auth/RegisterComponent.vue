  ...
  <main class="sign">
    ...
    <div class="sign__container">
      ...
      <div class="sign-main">
        ...
        <!-- Form -->
        <form class="sign-main__form" id="sign-up-form" action="register" method="post">
          ...
          <!-- Submit button -->
          <button
            class="sign-main__submit-btn btn btn--xs btn--blue"
            type="submit"
          >Сreate My Account</button>
        </form>
        ...
        <footer class="sign-main__footer">
          ...
          <!-- Sign up button -->
          <a class="sign-main__sign-up-btn btn btn--xs btn--ghost-blue" href="login">Login</a>
        </footer>
      </div>
